    ...
    >
              ...
              <div className="flex items-center gap-2 flex-1 max-w-md">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 rounded-full border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a] text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-[#E2281B] focus:border-transparent"
                    autoFocus
                    onBlur={() => {
                      if (!searchQuery) {
                        setShowSearch(false)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-4 sm:py-5 md:py-6 lg:py-8 space-y-3 md:space-y-4 lg:space-y-5 pb-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm overflow-hidden">
              <Tag className="h-4 w-4 text-[#E2281B]" />
              <div className="relative h-5 overflow-hidden">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="text-[#E2281B] font-medium inline-block"
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 whitespace-nowrap rounded-full border px-3 py-1.5 text-sm font-semibold transition-colors ${
                      selectedMenuCategory === "all"
                        ? "border-[#E2281B] bg-[#FEF2F2] text-[#E2281B]"
                      ...
                      {sectionItems.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex gap-4 p-4 border-b border-gray-100 last:border-none relative cursor-pointer transition-all duration-300 ${highlightedDishId === item.id ? "bg-red-50 ring-2 ring-[#E2281B] ring-inset dark:bg-red-950/20" : ""}`}
                              ...
                              {isRecommendedItem(item) && (
                                <div className="flex items-center gap-2 mt-1">
                                  <div className="h-1.5 w-16 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                    <div className="h-full bg-[#E2281B] w-3/4"></div>
                                  </div>
                              ...
                              {quantity > 0 ? (
                                <motion.div
                                  ...
                                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white border font-bold px-4 py-1.5 rounded-lg shadow-md flex items-center gap-1 ${shouldShowGrayscale
                                    ...
                                    : 'border-[#00a63e] text-[#00a63e] hover:bg-[#00a63e]/10'
                                    }`}
                                >
                                  <button
                                    onClick={(e) => {
                                    ...
                                    className={shouldShowGrayscale ? 'text-gray-400 cursor-not-allowed' : 'text-[#00a63e] hover:text-[#00a63e]'}
                                  >
                                    <Minus size={14} />
                                  </button>
      ...
      {!showFilterSheet && !showMenuSheet && !showMenuOptionsSheet && (
        <div className="sticky dark:bg-[#1a1a1a] bottom-4 flex justify-end px-4 z-50 mt-auto">
          <Button
            className="bg-[#1a1a1a] dark:bg-[#E2281B] hover:bg-black dark:hover:bg-[#E2281B] text-white flex items-center gap-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 dark:border-[#E2281B]/20 px-6 py-6 rounded-full font-bold transform transition-all duration-300 hover:scale-110 active:scale-95 group"
            size="lg"
            onClick={() => setShowMenuSheet(true)}
          >
            <Utensils className="h-5 w-5 text-[#E2281B] dark:text-white group-hover:rotate-12 transition-transform" />
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4 bg-white dark:bg-[#1a1a1a]">
                    <Button
                      className="w-full bg-[#1a1a1a] dark:bg-[#E2281B] hover:bg-[#E2281B] dark:hover:bg-[#E2281B] text-white border-0 flex items-center justify-center gap-2 py-6 rounded-xl font-bold transition-all shadow-lg"
                      onClick={() => setShowMenuSheet(false)}
                    >
                      <X className="h-5 w-5" />
                      Close
              ...
              <>
                ...
                >
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border-2 transition-all w-full ${filters.highlyReordered
                          ? "border-[#E2281B] dark:border-[#E2281B] bg-[#FEF2F2] dark:bg-[#E2281B]/20 text-[#E2281B] dark:text-[#E2281B]"
                          : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#2a2a2a] text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600"
                          }`}
                      >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between bg-white dark:bg-[#1a1a1a]">
                    ...
                    <Button
                      className="bg-[#E2281B] hover:bg-[#E2281B] text-white px-6 py-2.5 rounded-lg font-bold"
                      onClick={() => setShowFilterSheet(false)}
                    >
                    ...
                    {restaurant?.outlets && Array.isArray(restaurant.outlets) && restaurant.outlets.length > 0 ? (
                      <div className="space-y-2">
                        {restaurant.outlets.map((outlet) => (
                          ...
                          >
                            {outlet?.isNearest && (
                              <div className="flex items-center gap-1.5 mb-2 px-2 py-1 bg-[#FEF2F2] dark:bg-[#E2281B]/20 rounded-md">
                                <Zap className="h-3.5 w-3.5 text-[#E2281B] dark:text-[#E2281B] fill-[#E2281B] dark:fill-[#E2281B]" />
                                <span className="text-xs font-semibold text-[#E2281B] dark:text-[#E2281B]">
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4">
                    <Button
                      className="w-full bg-[#E2281B] hover:bg-[#E2281B] text-white py-3 rounded-lg font-bold"
                      onClick={() => {
                        setShowManageCollections(false)
                      }}
                    >
